...
> **R:** el preprocesador expande las librerias del #include y las copia y pega en el codigo
...
> **R:** porque el preprocesador borra todos los comentarios al generar el programa.i
...
> **R:** el 1er comando no muestra nada. el 2do: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:** comunican numero de linea y nombre de archivo. Proviene de stdio.h
...
> **R:** porque en matematica.o es donde el codigo esta realmente definido
...
> **R:** porque son funciones de la biblioteca dinamica del sistema. el cargador dinamico las resuelve cuando el programa se ejecute
